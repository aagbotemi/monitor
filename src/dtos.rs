...
#[derive(Debug, Serialize, Deserialize)]
pub struct UserLogoutResponseDto {
    pub status: String,
}
...
//     #[validate(
//         length(min = 1, message = "Password is required"),
//         must_match(other = "password", message = "Password must be at least 6 characters")
//     )]
//     #[serde(rename = "passwordConfirm")]
//     pub password_confirm: String,
// }
...
//     #[validate(
//         length(min = 1, message = "Password is required"),
//         range(min = 6, message = "Password must be at least 6 characters")
//     )]
//     pub password: String,
// }
